    ...
    <div className="dark:text-white ">
      <main className="p-6">
        <form className="space-y-4" onSubmit={enviarCotizacion}>
          <div>
            <label htmlFor="marca-select">Elige un vehiculo:</label>
            <div className="mt-2">
          ...
          <div className="mt-2">
            <label htmlFor="marca-select">Ingrese su cedula:</label>
            <div className="mt-2">
              <div className="mx-auto flex rounded-md ring-1 ring-inset ring-gray-300  sm:max-w-md ">
                <input
                  {...cedula}
          ...
          <button
            className="mt-5 p-2 text-black border dark:text-white border-gray-300 rounded"
            type="submit" /*onClick={imprimirCotizacion}*/
          >
            Obtener cotización
          </button>

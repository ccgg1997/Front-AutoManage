...
import { getUsuarioByIdentificacion, createVenta } from '../../../components/api/adress';
                    ...
                    <div className="mt-10 sm:grid-cols-6">
                        ...
                        <div className="mt-2">
                            <div className="mx-auto flex rounded-md ring-1 ring-inset ring-gray-300  sm:max-w-md">
                                <input disabled className="text-center flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 
                                    focus:ring-0 sm:text-sm   dark:text-white" value={formData.valor_total} />
                            </div>
                        </div>
                    </div>
                    <div className="mt-10 sm:grid-cols-6">

...
export default function SeleccionarCotizacion({ updateVehiculoInfo, actionVehiculoSeleccionado }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            cotizaciones.map((coti) => {
                ...
                coti.vehiculo = coti.inventario_vehiculos.vehiculo.marca + ' - ' + coti.inventario_vehiculos.vehiculo.linea;
